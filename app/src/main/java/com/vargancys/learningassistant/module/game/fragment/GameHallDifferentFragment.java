...
import com.vargancys.learningassistant.module.game.adapter.GameHallDifferentAdapter;
 ...
 * Description: 关卡大厅难度碎片
 */
public class GameHallDifferentFragment extends BaseFragment implements BaseGameHallView {
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    private GameHallDifferentAdapter mAdapter;
    ...
    public int getLayoutId() {
        return R.layout.fragment_game_different;
    }
    ...
    protected void initView() {
        ...
        mAdapter = new GameHallDifferentAdapter(getContext(),mHall);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(mAdapter);
        mPresenter.getHallDifferentData();
