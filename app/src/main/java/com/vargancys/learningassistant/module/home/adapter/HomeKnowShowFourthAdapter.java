 ...
 * version:1.0
 */
public class HomeKnowShowFourthAdapter extends BaseRecyclerAdapter {
    private List<HomeKnowFunction> homeKnowFunctions;
    private Context mContext;
    private String[] mCommon = {"不认识","偶尔","经常","已遗忘"};
    public HomeKnowShowFourthAdapter(Context context, List<HomeKnowFunction> homeKnowFunctions){
