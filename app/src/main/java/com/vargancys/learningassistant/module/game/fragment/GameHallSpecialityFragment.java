 ...
 * Description: 关卡大厅质量碎片
 */
public class GameHallSpecialityFragment extends BaseFragment implements BaseGameHallView {
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    private GameHallSpecialityAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mAdapter = new GameHallSpecialityAdapter(getContext(),mHall);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(mAdapter);
        mPresenter.getHallSpecialityData();
