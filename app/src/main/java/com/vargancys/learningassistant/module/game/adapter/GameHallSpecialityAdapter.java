 ...
 */
public class GameHallSpecialityAdapter extends BaseRecyclerAdapter {
    private List<GameHallRankBean> mBean;
    public GameHallSpecialityAdapter(Context context, List<GameHallRankBean> bean){
        super(context);
        mBean = bean;
    }
    ...
    public CommonViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new GameHallViewHolder(getView(R.layout.item_game_hall_speciality));
    }
