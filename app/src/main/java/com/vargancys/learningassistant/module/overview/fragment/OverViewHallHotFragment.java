...
public class OverViewHallHotFragment extends BaseFragment implements BaseHallView {
    ...
    private OverViewHallHotAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mAdapter = new OverViewHallHotAdapter(getContext(),mHall);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(mAdapter);
        mPresenter.getHallHotData();
    ...
    public void getHallDataFail(int error, String message) {
        ToastUtils.ToastText(getContext(),R.string.overview_hall_hot_fail_text);
    }
