...
public class RegisterActivity extends BaseActivity implements RegisterView {
    ...
    public void saveNameFinish() {
        ToastUtils.ToastText(getContext(), R.string.register_save_win_text);
    ...
    @OnClick({R.id.common_back, R.id.common_img, R.id.register_name_close,
            R.id.register_password_close, R.id.register_submit})
    ...
    private void isName(){
        ...
        if(name.isEmpty()){
            ToastUtils.ToastText(getContext(),R.string.register_name_empty_text);
            return;
        }
        if(password.isEmpty()){
            ToastUtils.ToastText(getContext(),R.string.register_password_empty_text);
            return;
        }
