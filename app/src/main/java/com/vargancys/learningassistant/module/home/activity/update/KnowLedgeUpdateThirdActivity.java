 ...
 * 知识展示三级页面
 */
public class KnowLedgeUpdateThirdActivity extends BaseActivity implements BaseKnowLedgeUpdateView {
    ...
    public static void launch(Activity activity,int REQUEST_CODE, long content_id,long data_id){
        Intent intent = new Intent(activity, KnowLedgeUpdateThirdActivity.class);
