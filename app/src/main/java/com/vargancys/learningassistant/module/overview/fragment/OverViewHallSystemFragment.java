...
import com.vargancys.learningassistant.module.overview.adapter.OverViewHallSystemAdapter;
...
public class OverViewHallSystemFragment extends BaseFragment implements BaseHallView {
    ...
    private OverViewHallSystemAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mAdapter = new OverViewHallSystemAdapter(getContext(),mHall);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(mAdapter);
        mPresenter.getHallSystemData();
    ...
    public void getHallDataFail(int error, String message) {
        ToastUtils.ToastText(getContext(),R.string.overview_hall_system_fail_text);
    }
