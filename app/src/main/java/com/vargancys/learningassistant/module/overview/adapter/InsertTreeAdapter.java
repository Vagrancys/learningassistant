 ...
 */
public class InsertTreeAdapter<T> extends TreeListViewAdapter<T> {
    private List<KnowListBean> mData;
    public InsertTreeAdapter(ListView mTree, Context content, List<KnowListBean> datas,
        ...
        viewHolder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(onInsertClickListener != null){
                    onInsertClickListener.update(position,knowListBean.getKnowId());
                }
            }
        });
    }
