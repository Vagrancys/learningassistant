...
public class SubjectRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public SubjectRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public SubjectRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new SubjectRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == SubjectRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            }else if(parent == SubjectRadioGroup.this
