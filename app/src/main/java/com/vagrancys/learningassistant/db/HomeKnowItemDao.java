...
*/
public class HomeKnowItemDao extends AbstractDao<KnowLedgeBean, Long> {
    ...
    @Override
    protected final void attachEntity(KnowLedgeBean entity) {
    ...
    protected KnowLedgeBean loadCurrentDeep(Cursor cursor, boolean lock) {
        KnowLedgeBean entity = loadCurrent(cursor, 0, lock);
    ...
    public KnowLedgeBean loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<KnowLedgeBean> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<KnowLedgeBean> list = new ArrayList<KnowLedgeBean>(count);
    ...
    protected List<KnowLedgeBean> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<KnowLedgeBean> queryDeep(String where, String... selectionArg) {
