...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig temporaryFeelingDbDaoConfig;
    ...
    private final TemporaryFeelingDbDao temporaryFeelingDbDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        temporaryFeelingDbDaoConfig = daoConfigMap.get(TemporaryFeelingDbDao.class).clone();
        temporaryFeelingDbDaoConfig.initIdentityScope(type);
        ...
        temporaryFeelingDbDao = new TemporaryFeelingDbDao(temporaryFeelingDbDaoConfig, this);
        ...
        registerDao(TemporaryFeelingDb.class, temporaryFeelingDbDao);
    }
    ...
    public void clear() {
        ...
        temporaryFeelingDbDaoConfig.clearIdentityScope();
    }
    ...
    public TemporaryFeelingDbDao getTemporaryFeelingDbDao() {
        return temporaryFeelingDbDao;
    }
